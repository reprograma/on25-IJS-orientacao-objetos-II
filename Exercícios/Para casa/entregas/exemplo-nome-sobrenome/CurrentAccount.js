...
class CurrentAccount extends BankAccount {
  transferTo(anotherAccount, amount) {
    ...
    if (this.balance >= amountToBeDebited) {
      ...
      console.log(
        `Saldo insuficiente para realizar a transferência. Seu saldo atual é de ${this.balance}. Para realizar essa transferência você precisa ter ${amountToBeDebited} em conta.`
      );
    }
  }
}
